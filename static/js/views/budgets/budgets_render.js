                ...
                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:14px;padding-bottom:12px;border-bottom:1px solid var(--border-color);flex-wrap:wrap;gap:10px;">
                    <div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap;">
                        ...
                        <div style="display:flex;align-items:center;gap:6px;background:var(--bg-surface);padding:2px 8px;border-radius:6px;border:1px solid var(--border-color);" title="Sensibilité aux dépenses exceptionnelles et imprévus historiques">
                            ...
                            <input id="aiOutlierSensitivitySlider" type="range" min="1" max="5" value="2" step="1" style="width:70px;cursor:pointer;accent-color:var(--accent);" onchange="window.BudgetsView.updateOutlierSensitivity(this.value)">
